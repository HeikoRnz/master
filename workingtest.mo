within ;
model ETAFactory_partial_B_2_working_fmu
extends fmuIcon;
...
public
  parameter String fmi_instanceName="ETAFactory_partial_B_2_working_fmu"
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://ETAFactory_partial_B_2_working_fmu/Resources/Library/FMU/ETAFactory_partial_B_2_working/resources")
...
void * ETAFactoryLib_Applications_ConnectedSystems_EtaFactory_0partial_0B_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2ModelExchange, \"{f41a6c0c-ea0d-4ed0-adde-d89aa64129e0}\",resourceLocation, &funcs, fmi2False, loggingOn);
...
#endif", Library="ETAFactoryLib_Applications_ConnectedSystems_EtaFactory_0partial_0B", LibraryDirectory="modelica://ETAFactory_partial_B_2_working_fmu/Resources/Library/FMU/ETAFactory_partial_B_2_working/binaries", __Dymola_CriticalRegion="ETAFactoryLib_Applications_ConnectedSystems_EtaFactory_0partial_0B");
      end constructor;
...
#endif", Library="ETAFactoryLib_Applications_ConnectedSystems_EtaFactory_0partial_0B", LibraryDirectory="modelica://ETAFactory_partial_B_2_working_fmu/Resources/Library/FMU/ETAFactory_partial_B_2_working/binaries", __Dymola_CriticalRegion="ETAFactoryLib_Applications_ConnectedSystems_EtaFactory_0partial_0B",__Dymola_IdemPotent=true);
    end fmiSetTime;
...
equation
  ...
  {condensingBoiler.tableEfficiency.tableID.id, cHP.Tableefficency_P_th.tableID.id, cHP.Tableefficency_P_el.tableID.id, cHP.Tableefficency_P_gs.tableID.id} = fmi_Functions.fmiGetIntegerwf(fmi, {100663633, 100663883, 100663906, 100663922}, integer(fmi_dummy));
  end when;
...
{pump_simple_controlled_cHP.greaterThreshold.y, pump_simple_controlled_Boiler.greaterThreshold.y} = fmi_Functions.fmiGetBooleanwf(fmi, {369099820, 369100029}, if initial() then integer(myTimeStart) else integer(myTime));
  end when;
initial equation
  ...
  cHP.Tableefficency_P_th.tableOnFileRead = fmi_Functions.GetRealVariable(fmi, myTimeStart, fill(0.0,0), fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), {100663884});
  cHP.Tableefficency_P_el.tableOnFileRead = fmi_Functions.GetRealVariable(fmi, myTimeStart, fill(0.0,0), fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), {100663907});
  cHP.Tableefficency_P_gs.tableOnFileRead = fmi_Functions.GetRealVariable(fmi, myTimeStart, fill(0.0,0), fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), {100663923});
...
<li>generationDateAndTime = 2018-10-29T23:40:32Z</li>
</ul>
...
end ETAFactory_partial_B_2_working_fmu;
